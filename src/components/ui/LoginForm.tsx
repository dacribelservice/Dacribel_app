  ...
  return (
    <main className="w-full max-w-md mx-auto px-4">
      ...
      <div className="flex flex-col items-center mb-10">
        <h1 className="text-3xl font-black text-action tracking-tighter select-none">
          DACRIBEL
        </h1>
      </div>
      ...
      <div className="bg-secondary/40 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden border border-white/5">
        ...
        {/* SSO Integration */}
        <button className="w-full bg-background/50 hover:bg-background/80 transition-all duration-300 rounded-2xl py-4 px-6 flex items-center justify-center gap-3 group mb-6 border border-white/5">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-[10px] font-bold text-inactive uppercase tracking-widest">
            O CON EMAIL
          </span>
          <div className="h-[1px] flex-1 bg-white/5"></div>
        </div>
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              <label className="block text-[10px] font-bold text-inactive uppercase tracking-[0.2em]">
                CONTRASEÑA
              </label>
              <Link
                className="text-[10px] font-bold text-action hover:brightness-110 transition-colors uppercase tracking-[0.1em]"
            ...
            <div className="relative group rounded-2xl overflow-hidden transition-all border border-white/5 focus-within:border-action/50 bg-background/30 focus-within:bg-background/50">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Lock className="text-inactive w-5 h-5 group-focus-within:text-action transition-colors" />
              </div>
              <input
                className="w-full bg-transparent border-none py-4 pl-12 pr-12 text-white placeholder:text-inactive/50 focus:ring-0 text-sm outline-none"
                placeholder="••••••••"
                type="password"
              />
              <div className="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer text-inactive hover:text-action transition-colors">
